      ...
      <section class="blog-detail">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              <div class="txt-wrap">
                <h1 class="blog-heading">SIMPLY TIPS FOR BEAUTY</h1>
                <p>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.</p>
              </div>
              <div class="img-holder">
                <img src="http://placehold.it/1140x485" alt="image description">
              </div>
              <!-- Blockquote of the page -->
              <blockquote class="blockquote">
                <q>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis nequerat sed fermentum feugiat.</q>
              </blockquote>
              <div class="txt-wrap">
                <p>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque.</p>
              </div>
                ...
                <li>
                  ...
                  <div class="comment-info">
                    <div class="header">
                      <div class="heading">
                        <h2>Admin</h2>
                        <time class="time" datetime="2016-04-03 20:00">April 10, 2016 | 11.25 am</time>
                      </div>
              ...
              <div class="leave-comment">
                ...
                <form action="#" class="comment-form">
                  <fieldset>
                    ...
                    <div class="form-group">
                      <textarea class="form-control" placeholder="Your messge"></textarea>
                    </div>
                    <div class="form-group">
