      ...
      <section class="about-dscrp wow fadeInUp" data-wow-delay="0.4s">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              <div class="img-holder">
                <img src="http://placehold.it/520x450" alt="image description">
              </div>
              <div class="text-wrap">
                <h1 class="about-heading">ABOUT US</h1>
                <strong class="title">love jewelry</strong>
                <p>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim pharetra, erat sed fermentum feugiat.</p>
                <ul>
      ...
      <section class="social-rating wow fadeInUp" data-wow-delay="0.4s">
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 text-center">
              <h3>PIECES SOLD</h3>
              <span class="rating"><span class="counter">23.741</span> k</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="header text-center">
                <span class="title">Our Awesome Team</span>
                <h3 class="about-heading">MEET OUR TEAM</h3>
              </div>
              <ul class="list-unstyled team-slider">
                <li>
                  <div class="img-holder">
                    <img src="http://placehold.it/360x470" alt="image description">
                  </div>
                  <h4><a href="#">Christine Jensen</a></h4>
                  <span class="sub-title">Art Drector</span>
                </li>
                <li>
                  <div class="img-holder">
                    <img src="http://placehold.it/360x470" alt="image description">
