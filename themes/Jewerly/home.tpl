...
<body>
  ...
  <div id="wrapper">
    ...
    <main id="main" role="main">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="beans-slider">
                    <div class="border">
                      <h1 class="slider-heading">Back to dream</h1>
                      <div class="img-holder">
                        <img src="http://placehold.it/440x660" alt="image description">
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section class="banner banner-2 wow fadeInUp" data-wow-delay="0.4s" style="background-image: url(http://placehold.it/1920x1000);">
            ...
            <div class="col-xs-12">
                <div class="caption-holder">
                  <div class="text-holder">
                    ...
                    <p>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam <br>massa nisl quis neque. Suspendisse in orci enim pharetra, erat sed fermentum <br>feugiat, velit mauris egestas quam ut aliquam massa Suspendisse in orci <br>enim.pharetra, erat sed fermentum feugiat.</p>
                    <a href="about-us.html" class="btn-more">Read more <i class="icon-right-arrow"></i></a>
                  </div>
                  <div class="img-holder">
                    <img src="http://placehold.it/390x330" alt="image description">
                  </div>
                </div>
            </div>
          </div>
                ...
                <div class="col-xs-12 text-center">
                  ...
                  <div class="blockquote-holder">
                    <div class="author-img">
                      <img src="http://placehold.it/135x135" alt="image description">
                    </div>
                    <h2 class="author-name">Press Spaceba</h2>
                    <p>Pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliqua m massa nisl quis neque. Suspendisse in orci enim pharetra, erat sed fermentum feugiat, velit mauris egestas quam ut aliquam massa uspendisse .</p>
                  </div>
                </div>
              </div>
            </div>
